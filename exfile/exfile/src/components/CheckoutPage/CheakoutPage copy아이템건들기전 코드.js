...
const CheckoutPage = () => {
    ...
    const orderedItems = [
        {
            id: 1,
            name: "NIKE 리버풀 24/25 STADIUM HOME KIT",
            quantity: 1,
            price: 129000
        },
        {
            ...
            <div className='CheakoutPage_header'>
                <div className="CheakoutPage_header_01">
                    ...
                    <div className='CheakoutPage_Basket_MyPage'>
                        <button className='CheakoutPage_Basket'><FontAwesomeIcon icon={faShoppingCart} /> </button>
                        <button className='CheakoutPage_MyPage'><FontAwesomeIcon icon={faUser} /> </button>
                ...
                {isVisible3 && (
                    <div>
                        ...
                        {orderedItems.map((item) => (
                            <div className="CheakoutPage_Ordered_Items_ItemBox">
                                ...
                                <div className='CheakoutPage_Ordered_Items_TextBox'>
                                    <div className="CheakoutPage_Ordered_Items_Iemag">
                                        <a href=""><img src="https://search.pstatic.net/sunny/?src=https%3A%2F%2Fcdn.footballist.co.kr%2Fnews%2Fphoto%2F202307%2F170147_100300_4428.jpg&type=sc960_832" alt="" /></a>
                                    </div>
                                    {/* 텍스트 박스------------ */}
                                    <div className="CheakoutPage_Ordered_Items_content">
                                        <strong className="CheakoutPage_Ordered_Items_Title" title="">
                                            <a key={item.id} href="" className="">NIKE 리버풀 24/25 STADIUM HOME KIT [프리미어리그]</a>
                                        </strong>
                                        <ul className="CheakoutPage_Ordered_Items_Body">
                                            <li title="">
                                                <p className="CheakoutPage_Ordered_Items_Price">[옵션: 프리미어리그 패치 (-129,000)]</p>
                                            </li>
                                            <li className='CheakoutPage_Ordered_Items_Quantity'>수량: 1개</li>
                                            <li id="" className="CheakoutPage_Ordered_Items_Sale">
                                                <div>{item.name} ({item.quantity}개) - {item.price * item.quantity}원</div>
                                                {/* 할인금액: <span className="">-<span id="">1</span>원 </span>
                                                  <span className="">(1%)</span> */}
                                            </li>

                                        </ul>
                                        <div className="">
                                            <span className="CheakoutPage_Ordered_Items_TotalPrice">20,000원</span>
                                        </div>
                                    </div>

                                    <button type="button" className="CheakoutPage_Ordered_Items_BtnRemove " id="" >x</button>
                                </div>
