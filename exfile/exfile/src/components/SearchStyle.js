            ...
            <TotalSearchHead />
                ...
                <div className="SearchStyle_sns_container">
                    <ul className="SearchStyle_detail_page_review_list_body">
                        ...
                        <li className="SearchStyle_detail_page_review_list_item">
                            ...
                            <div className="SearchStyle_detail_page_review_content">
                                ...
                                <div className="SearchStyle_detail_page_review_title">
                                    <img src="https://fakeimg.pl/26x26/" alt="" className="SearchStyle_detail_page_review_title_img" />
                                    <span className="SearchStyle_detail_page_review_title_id">아이디</span>
                                    <span className="SearchStyle_detail_page_review_title_like">♡4</span>
                                </div>
                                <p className="SearchStyle_detail_page_review_body_tag">#겨울코디추천 #겨울코디추천 #아우터추천 #연말선물 #연말룩 #사이즈팁 #KICKS
                                </p>
                            </div>
                        </li>
