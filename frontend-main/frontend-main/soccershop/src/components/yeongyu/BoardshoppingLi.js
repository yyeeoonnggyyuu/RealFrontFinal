...
import '../css/BoardshoppingLi.css';
                ...
                <div className="selectArray">
                    <div className="sort">
                        <select id="selArray" name="selArray" className="selArray">
                            <option value="" className="selArray_list">신상품</option>
                            <option value="" className="selArray_list">상품명</option>
                            <option value="" className="selArray_list">낮은가격</option>
                            <option value="" className="selArray_list">높은가격</option>
                            <option value="" className="selArray_list">제조사</option>
                            <option value="" className="selArray_list">사용후기</option>
                        </select>
                    </div>
                    <span className="selArray_displaynone">
                        <a href="#none" className="btnCompare" onClick={() => {}}>상품비교</a>
                    </span>
                </div>
            </div>
